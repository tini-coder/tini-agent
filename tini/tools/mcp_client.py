"""MCP connector — plug any Model Context Protocol server into Tini's tools.

Tini's loop is synchronous; the MCP SDK is async. The bridge below runs one
